                        ...
                        <tr>
                            ...
                            <td>
                                <a href="" class="btn btn-primary text-white" data-bs-toggle="modal"
                                    data-bs-target="#modalEditSparepart" data-id="{{ $artikel->id }}"
                                    data-name="{{ $artikel->judul }}" data-category="{{ $artikel->kategori }}"
                                    data-deksripsi="{{ $artikel->deskripsi }}"><i class="fas fa-edit"></i></a>
            ...
            <div class="modal-body">
                <form action="{{ route('artikel.store') }}" method="post">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="category" name="kategori">
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <input class="form-control" name="gambar" type="file" placeholder="Pilih gambar"
