        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="" method="POST" id="editForm" name="editForm">
                    ...
                    <label for="vehicleType" class="mt-2"><b>Vehicle Type</b></label>
                    <select name="vehicleType" id="vehicleType" class="form-control mt-2" disabled>
                    ...
                    <select name="vehicleTransmission" id="vehicleTransmission" class="form-control mt-2">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="" method="POST" id="editFormBooking" name="editFormBooking">
                    @csrf
                    @method('PUT')
                    <label for="name" class="mt-2"><b>Status</b></label>
                    <select name="statusEdit" id="statusEdit" class="form-control mt-2">
