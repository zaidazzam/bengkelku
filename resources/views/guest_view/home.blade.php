            ...
            <div class="accordion-item">
              ...
              <div id="collapseOne" class="accordion-collapse collapse show" aria-labelledby="headingOne"
                ...
                <div class="accordion-body">
                  Bengkel Tunas Santosa Mandiri terletak di Jln. Raya Inpres Klapasawit No.07 Purwojati, Kodepos 53175, Kabupaten Banyumas
                </div>
              </div>
            </div>
            <div class="accordion-item">
          ...
          <div class="info-table">
            <ul>
              <li>
                ...
                <h4 class="text-linked"><a href="https://maps.app.goo.gl/tf88pVETDHAjjVt78" target="_blank">Jl. Purwojati - Cilongok, Klapasawit Kidul, Klapasawit, Kec. Purwojati, Kabupaten Banyumas, Jawa Tengah 53175</a><br><span>Alamat</span></h4>
              </li>
              <li>
                <img src="assets/images/info-icon-02.png" alt="Gambar Ilustrasi" style="max-width: 52px;">
                <h4 class="text-linked"><a href="https://api.whatsapp.com/send?phone=085647774677">085647774677</a><br><span>Kontak</span></h4>
              </li>
            </ul>
          </div>
        </div>
      ...
      <div class="row">
        <div class="col-lg-10 offset-lg-1">
          <div class="video-frame">
            ...
            <a href="https://www.youtube.com/watch?v=FyqdgilCiTY" target="_blank"><i class="fa fa-play"></i></a>
          </div>
        </div>
      </div>
    </div>
